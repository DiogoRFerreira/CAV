...
(function(e) {
    ...
    t.registerPlugin(I, function(e) {
        ...
        return typeof e == gt ? H : (e.fn[p] = function() {
            ...
            var r = this[n], i = e(this[j]), s = this;
            ...
            if (!r[b] ||!(r[b]in this[bt]))
                r[b] = "top-left";
            r[en] || (r[en] = this[bt][r[b]][en]);
            if (!r[tt] || typeof r[tt] !== $t&&!(r[tt]in this[lt]))
                r[tt] = yt;
            r.clickToHide && i[At]("a")[S](nt, zt).on("click.skel-layers", function(r) {
                ...
                if (r[rt] && r.swipeToHide) {
                    ...
                    if (a)
                        return s[St] = x, s[xt] = x, s[It](), H
                }
                if (i[B]() == 0 && n < 0 || u > o - 2 && u < o + 2 && n > 0)
                    return H
            }), this[h] = i
        }, Nn[C][Z] = function() {
            return this[h] !== x
            ...
            parseInit: function(n) {
                var r, s, o = n.get(0), u = n[Lt]("data-action"), a = n[Lt]("data-args"), c, h;
                u && a && (a = a.split(","));
                switch (u) {
                case"toggleLayer":
                case"layerToggle":
